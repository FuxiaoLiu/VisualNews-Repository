...
if __name__ == '__main__':
    ...
    parser.add_argument('--caption_path', type=str, default='./train_n_t1.json', help='path for train annotation file')
    parser.add_argument('--vocab_path', type=str, default='./vocab/vocab_n.pkl',help='path for saving vocabulary wrapper')
    ...
    parser.add_argument('--threshold', type=int, default=2, help='minimum word count threshold')
