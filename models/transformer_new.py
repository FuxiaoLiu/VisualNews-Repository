...
def translate_sentence(model, src, word_map, caplens, device):
    model.eval()
...
def bleu(arts, model, word_map, caplens, device):

    prediction = translate_sentence(model, arts, word_map, caplens, device)
